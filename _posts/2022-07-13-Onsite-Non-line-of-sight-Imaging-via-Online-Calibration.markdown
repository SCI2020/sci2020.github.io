...
![a]({{site.baseurl}}/OIvOC_images/scenarioTop.pdf "A top-viewed scenario of the NLOS imaging system"){:height="100%" width="100%"}
...
<div align=center>
<img src="{{site.baseurl}}/OIvOC_images/calibrationValidation.pdf" height="70%" width="70%"/>
</div>
...
![c]({{site.baseurl}}/OIvOC_images/resultsGalleryWithBar.pdf "Reconstruction evaluation using transients measured from our calibrated NLOS imaging system"){:height="100%" width="100%"}
